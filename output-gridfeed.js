...
try {
    ...
    var listOfTags = "";
    var thumbNailString = "";
    var anchorTagWrapper = '<div class="hidden">' + anchorTag + '</div>'
    ...
    document.write(com.terminalfour.publish.utils.BrokerUtils.processT4Tags(dbStatement, publishCache, section, content, language, isPreview, anchorTagWrapper));
