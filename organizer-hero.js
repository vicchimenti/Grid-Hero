...
try {
    ...
    // declare content wrappers
    header = '<div class="heroOrganizerWrapper col-12 col-xs-12 order-xs-1 col-md-12 order-md-first border-0" id="id' + content.getID() + '" data-position-default="ZoneA" data-position-selected="ZoneA"><div class="heroOrganizer standardContent card-deck"><div class="heroOrganizerExtra"></div>';
    midder = '<span></span>';
