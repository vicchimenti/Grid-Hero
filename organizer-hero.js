...
try {
    ...
    // declare content wrappers
    header = '<div class="heroOrganizerWrapper col-12 col-xs-12 col-md-12 border-0" id="id' + content.getID() + '" data-position-default="ZoneA" data-position-selected="ZoneA"><div class="heroOrganizer standardContent d-flex flex-column card-deck"><div class="heroOrganizerExtra"></div>';
    midder = '<span></span>';
